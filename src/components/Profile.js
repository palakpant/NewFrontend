...
const Profile = () => {
  ...
  <img className="card-img-top" src={Locations} alt="Card image cap"/>
  <div className="card-body">
    <h5 className="card-title">Locations</h5>
    <p className="card-text">See the locations</p>
    <a href="/user" className="btn btn-warning">Move to Dashboard</a>
  </div>
</div>
